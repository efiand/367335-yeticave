        ...
        <ul class="pagination-list">
            ...
            <li class="pagination-item<?php if ($data['active'] == $val) : ?> pagination-item-active<?php endif; ?>"><a<?php if ($data['active'] != $val) : ?> href="index.php?page=<?= $val; ?>"<?php endif; ?>><?= $val; ?></a></li><?php endforeach; ?>
